        ...
        <Fade direction="down" delay={500}>
          ...
          <div className=" px-4 pb-2 flex flex-col justify-center items-center gap-5 lg:gap-15 p-3">
            ...
            <Link
              ...
              className="text-festify-red hover:text-white border-zinc-700 outline-none pt-2 pb-2 lg:pb-4  tracking-widest uppercase"
            >
          ...
          <Link to={`/profile/${id}/update`}>
            <Button textButton="Modifie ton profil" variant="red" />
          </Link>
        </Fade>
      </section>
      <img src={profilePic} className="w-100 h-130" />
      </section>
