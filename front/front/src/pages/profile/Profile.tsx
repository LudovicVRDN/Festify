  ...
  return (
    <div className="bg-metal-dark bg-metal-grid min-h-screen">
      <div className="flex flex-col items-center pt-15">
        ...
        <h1 className="font-metal text-xl lg:text-6xl text-center ">{`Bienvenue ${profile?.firstname}`}</h1>
      </div>
      <div className="pt-5">
          ...
          <section className="bg-black flex flex-col items-center gap-5">
            <Fade direction="down" delay={500}>
              ...
              <div className=" flex flex-col gap-5 w-55">
                <Button
                  textButton="Modifie ton profil"
                  variant="grey"
                  onClick={() => navigate(`/profile/${id}/update`)}
                />
                <Button
                ...
                {isModified && (
                  <p className="text-red-500 text-xs italic mt-2 ml-2">
                    Ton mot de passe est bien modifié !
                  </p>
                )}
                ...
                <dialog ref={modalRef} id="my_modal_1" className="modal">
                  <div className="modal-box bg-black border border-festify-glassred  ">
                    ...
                    <p className="py-4">
                      Ton nouveau mot de passe doit contenir au moins 8
                      caractères, un chiffre et un caractère spécial
                    </p>
                    <div>
                      <form
